...
MSG longblob
	 */
	@Query(value="SELECT title,image1,x,y,b.contentid,address,contenttype,hit,usefee,spendtime,parkingfee,discountinfo,infocenter,usetime,restdate,parking,msg FROM seoulTravel b JOIN culture a ON b.contentid = a.contentid WHERE b.contentid = :contentid",nativeQuery = true)
	...
	private String msg;
	 */
	@Query(value="SELECT title,image1,x,y,b.contentid,address,contenttype,hit,saleitem,saleitemcost,fairday,infocenter,restdate,parking,opentime,msg FROM seoulTravel b JOIN shopping a ON b.contentid = a.contentid WHERE b.contentid = :contentid",nativeQuery = true)
