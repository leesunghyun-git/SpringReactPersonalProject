...
public interface JejuTravelRepository extends JpaRepository<JejuTravel, Integer>{
	@Query(value="SELECT title,image1,contentid,address,contenttype,hit FROM jejutravel ORDER BY hit desc LIMIT 4",nativeQuery = true)
	...
	@Query(value="SELECT title,image1,x,y,b.contentid,address,contenttype,hit,infocenter,restdate,usetime,parking,msg FROM jejuTravel b JOIN Attraction a ON b.contentid = a.contentid WHERE b.contentid = :contentid",nativeQuery = true)
...
MSG longblob
	...
	private String msg;
	 */
	@Query(value="SELECT title,image1,x,y,b.contentid,address,contenttype,hit,eventstartdate,eventenddate,agelimit,playtime,eventplace,eventhomepage,usetime,spendtime,msg FROM jejuTravel b JOIN festival a ON b.contentid = a.contentid WHERE b.contentid = :contentid",nativeQuery = true)
	...
	private String msg;
	 */
	@Query(value="SELECT title,image1,x,y,b.contentid,address,contenttype,hit,roomtype,checkintime,checkouttime,chkcooking,subfacility,foodplace,reservationurl,infocenter,parking,msg FROM jejuTravel b JOIN stay a ON b.contentid = a.contentid WHERE b.contentid = :contentid",nativeQuery = true)
